...
public class Menu extends JFrame implements ActionListener{
	...
	JMenuItem add2=new JMenuItem("添加课程   ");
	JMenuItem updata2=new JMenuItem("更新课程信息   ");
	JMenuItem delete2=new JMenuItem("删除课程   ");
	JMenu m3=new JMenu("选课管理");
	JMenuItem add3=new JMenuItem("添加选课   ");
	JMenuItem updata3=new JMenuItem("更新选课信息   ");
...
//	JMenu m6=new JMenu("停止音乐");
	Font t=new Font ("sanerif",Font.PLAIN,12);
	public Menu (){
		this.setTitle("1704070121刘鑫");  //  修改名字
		Music.playMusic1();
		...
		Image img2 = new ImageIcon("image\\44.jpg").getImage(); 
		p1.setIcon(new ImageIcon(img2)); 
